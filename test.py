...
#plt.show()
ttest_result_1 = stats.ttest_ind(a=A_1, b= B_1, equal_var=True)
ttest_result_2 = stats.ttest_ind(a=A_2, b= B_2, equal_var=True)
ttest_result_3 = stats.ttest_ind(a=A_3, b= B_3, equal_var=True)
